...
- [ ] **BOOT-02**: Script distinguishes a genuinely hung install from a slow-but-progressing one via heartbeat/timestamp polling, avoiding false-negative timeouts on slow Docker pulls
