...
- [ ] 07-01-PLAN.md — install.sh: mark_step_activity() heartbeat helper writing a world-readable Unix timestamp to /run/ppsa-install.activity, wired into Step 3's Docker pull/up loops (BOOT-02 guest side)
...
| 7. Boot-Chain Verification & Hang Detection | v1.5.0 | 0/2 | Planned | - |
